...
#         Effect = "Allow",
#         Principal = {
#           Federated = "arn:aws:iam::953523290929:oidc-provider/token.actions.githubusercontent.com"
#         },
#         Action = "sts:AssumeRoleWithWebIdentity",
#         Condition = {
#           StringLike = {
#             "token.actions.githubusercontent.com:sub" = "repo:MayorFaj/E-Commerce-Project:*"
#           },
#           StringEquals = {
...
#   name        = "EKSNodegroupFullECRAccess"
#   description = "Permissions to interact with an EKS cluster"
#   policy      = file("policies/GithubEKSAccessPolicy.json")
# }
